...
def buildModel(model_path, patch_rows=32, patch_cols=32, channels=1, block_size=8, use_circular=True):
    ...
    # decoder_model = Denoise_net()(decoder_model)
...
# Model Definition
model_path = './logs/{}/Weights/weights_40.h5'.format(exp_id)
...
attacks_list = [
    ...
    # {'func':jpg, 'name':'JPEG', 'params': np.array([90, 90, 90, 90, 90]), 'active':True}, # JPEG
    # {'func':jpg, 'name':'JPEG', 'params': np.array([70, 70, 70, 70, 70]), 'active':True}, # JPEG
    # {'func':jpg, 'name':'JPEG', 'params': np.array([50, 50, 50, 50, 50]), 'active':True}, # JPEG
    # {'func': jpg, 'name': 'JPEG', 'params': np.array([20, 20, 20, 20, 20]), 'active': True},  # JPEG
    {'func':jpg, 'name':'JPEG', 'params': np.array([10, 10, 10, 10, 10]), 'active':True}, # JPEG
    # {'func':jpg, 'name':'JPEG', 'params': np.array([4, 4, 4, 4, 4]), 'active':True}, # JPEG
    {'func': smoothing_mean, 'name': 'Average Filter', 'parms': np.array([3, 5, 7, 9]), 'active': False},
    # Smoothing meanyo
...
for test_img in test_imgs_files:
    ...
    mae_values_per_alpha_mean = []
    rmse_values_per_alpha_mean = []
    ...
    for alpha in alpha_values:
        ...
        for n in range(num_random_watermarks):
            ...
            # SSIM
            SSIM = structural_similarity(im_gray, Iw, win_size=9, data_range=255)
            tmp_ssim.append(SSIM)
            # MAE
            mae = np.mean(np.abs(im_gray - Iw))
            tmp_mae.append(mae)
            # RMSE
            rmse = np.sqrt(np.mean((im_gray - Iw) ** 2))
        ...
        mae_values_per_alpha_mean.append(np.mean(tmp_mae))
        rmse_values_per_alpha_mean.append(np.mean(tmp_rmse))
    ...
    mae_means.append(mae_values_per_alpha_mean)
    rmse_means.append(rmse_values_per_alpha_mean)
...
var_dict['mae_means'] = mae_means
var_dict['rmse_means'] = rmse_means
