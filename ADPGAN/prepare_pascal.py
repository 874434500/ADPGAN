...
# List all files
pascal_path = './images/pascal/imagenet'
...
with h5py.File('./images/pascal/image/image_pascal_patches.mat', 'w') as f:
...
# 6915231
# 11000000
with h5py.File('./images/pascal/image/image_pascal_patches.mat', 'r') as f:
    x_train = f['patches'][:]
...
# plt.hist(img_std)
# plt.show()
print(len(selected_img))
# Save new dataset
print('Saving mat file...')
train_imgs = np.array(selected_img)
# sio.savemat('./images/pascal/imagenet/image_pascal_resampled.mat', {'patches': train_imgs})

with h5py.File('./images/pascal/image/image_pascal_resampled.mat', 'w') as f:
    f.create_dataset('patches', data=train_imgs)
