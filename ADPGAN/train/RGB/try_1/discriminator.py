...
class Discriminator(Layer):
    ...
    def __init__(self):
        ...
        self.channels = 192
        self.message_length = 192
        self.input_img = layers.Input(shape=(32, 32, 3), batch_size=64)

        self.pre_layer = layers.Conv2D(self.channels, (1, 1), dilation_rate=1, activation='elu', padding='same')
