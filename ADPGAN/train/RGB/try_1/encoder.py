...
from RGB.try_1.Dense_block import Bottleneck
import tensorflow as tf
from include.my_circular_layer import Conv2D_circular
from RGB.try_1.Convnet import ConvBNRelu
from RGB.try_1.SENet import SENet
...
class Encoder(Layer):
    ...
    def __init__(self):
        ...
        self.final_layer = Conv2D_circular(filters=self.conv_channels, kernel_size=3, padding='same', activation='elu')
    ...
    def call(self, x, **kwargs):
        ...
        feature_mask = (self.sixth_layer(feature_attention3)) * self.conv_channels
