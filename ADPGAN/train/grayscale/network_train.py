...
from ARWgan.try_try.encoder import Encoder
from ARWgan.try_try.decoder import Decoder
from keras.datasets import cifar10
import os
from tqdm import tqdm
from ARWgan.try_try.discriminator import Discriminator
...
class ARWgan_RedMark():
    ...
    def build_model(self):
        ...
        output_decoder = self.build_decoder(output_encoder)
...
if __name__ == '__main__':
    ARWgan_model = ARWgan_RedMark(batch_size=64, epochs=150)
